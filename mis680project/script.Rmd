...
conns = read.delim("conns.txt", colClasses = c("character", "character"))
...
```{r, message=F, warning=F, fig.height=14, fig.width=10}
# plot network
